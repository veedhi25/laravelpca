...
import { useUpdateCategoryMutation } from "@data/shop-categories/use-category-update.mutation";
import { useCreateCategoryMutation } from "@data/shop-categories/use-category-create.mutation";
...
type IProps = {
  initialValues?: ShopCategory | null;
};
