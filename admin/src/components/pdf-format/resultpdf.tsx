...
const ResultPdf = ({data, attemptedCount, correctCount, incorrectCount , memoizedExamAttempts ,total_time_taken, getAnswerStatus , currentPage , entriesPerPage ,getOptionLabel , timeConverter }) => {
