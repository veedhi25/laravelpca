import ConfirmationCard from "@components/common/delivery-confirmation-card";
import { CheckMarkCircle } from "@components/icons/checkmark-circle";
import {
  useModalAction,
  useModalState,
} from "@components/ui/modal/modal.context";
import { useDeliveryShopMutation } from "@data/shop/use-delivery-status.mutation";

const ProductDeleteView = () => {
  const { mutate: disApproveShopById, isLoading: loading } =
    useDeliveryShopMutation();
