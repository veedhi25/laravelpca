...
import { useCreateBookMutation } from "@data/books/use-create-book.mutation";
import { useClassesQuery } from "@data/class/use-classes.query";


export default function CreateUpdateBook ({initialValues}) {
...
CreateUpdateBook.Layout = AdminLayout ;