...
import QuestionTypeList from "@components/question-type/question-type-list";
    ...
    <>
      <Card className="flex flex-col mb-8">
        <div className="w-full flex flex-col md:flex-row space-x-2 justify-evenly items-center">
          ...
          <Link href='/question-type/create'><Button className="bg-green-700">
            Add Question Type +
          </Button></Link>
          <Button
      ...
      <QuestionTypeList question_types={question_types} onPagination={handlePagination} />
    </>
  )
}

QuestionType.Layout = Layout;
