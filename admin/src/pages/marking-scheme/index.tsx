...
import MarkingSchemeList from "@components/marking-scheme/marking-scheme-list";
import { useMarkingSchemeQuery, useMarkingSchemesQuery } from "@data/marking-scheme/use-marking-scheme.query";
...
export default function MarkingScheme() {
    ...
    function handleImportModal() {
      ...
      const {data} = useMarkingSchemesQuery();
    ...
    <>
      <Card className="flex flex-col mb-8">
        <div className="w-full flex flex-col md:flex-row space-x-2 justify-evenly items-center">
          ...
          <Link href='/marking-scheme/create'><Button  className="bg-green-700">
            Add Marking Scheme +
          </Button></Link>
          <Button
      ...
      <MarkingSchemeList marking_scheme={data} onPagination={handlePagination} />
    </>
  )
}

MarkingScheme.Layout = Layout;
