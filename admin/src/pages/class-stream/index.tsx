...
import ClassStreamList from "@components/class-stream-list";
...
export default function ClassStream() {
  ...
  return (
    ...
    <>
      ...
      <ClassStreamList class_stream={data} onPagination={handlePagination} />
    </>
  );
}

ClassStream.authenticate = {
  permissions: adminOwnerAndStaffOnly,
};
ClassStream.Layout = Layout;
